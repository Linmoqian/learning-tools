...
### 前置依赖
- [[词性分类]] — 名词/动词/形容词/副词的辨析
- [[英语四级词汇]] — CET-4核心词汇的积累

### 后续应用
- [[01CET4-阅读-仔细阅读总览与答题策略]] — 整体阅读策略
- [[CET4-语法-非谓语动词与被动语态]] — 语法在选词填空中的应用

### 对比辨析
- 选词填空 vs 完形填空：选词填空给15个词选10个填入（词性辨析），完形填空给4个选项选1个（上下文理解）——选词填空更重词性和搭配
- 先定词性 vs 先看上下文：应该先快速标注词性，再根据上下文语义缩小范围
