...
### 前置依赖
- [[CET4-听力-新闻与篇章解题策略]] — 听力基本策略
- [[听力基本技巧]] — 语音识别、关键词捕捉

### 后续应用
- [[CET4-阅读-选词填空题解题策略]] — 信息匹配思维在阅读中的应用
- [[英语四级听力]] — 听力综合备考

### 对比辨析
- 长对话 vs 短对话（改革前）：长对话信息量大（1:50-2:00分钟，约250词），侧重对话题的整体理解和细节定位
- 预读选项 vs 边听边看：预读选项是听力解题的前提（提前标注关键词），边听边看确认选项和录音的一致性
