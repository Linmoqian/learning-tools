...
### 前置依赖
- [[07-02_偏导数与全微分]] — 偏导数的基本计算
- [[02-01_求导法则与基本公式]] — 一元复合函数求导链式法则

### 后续应用
- [[07-04_隐函数求导]] — 隐函数定理的推导
- [[07-05_隐函数组求导]] — 多方程隐函数组的求导
- [[07-06_多元函数的极值与条件极值]] — 极值问题的求解
