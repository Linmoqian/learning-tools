...
| 信号类型 | 具体词/模式 | 为什么要警惕 |
|----------|------------|-------------|
| **转折信号词** | but, however, yet, although, nevertheless | 转折后=出题人最爱设考点的地方 |
...
### 后续应用
- [[CET4-听力-长对话题型解题方法]] — 长对话的解题方法（听力部分的进阶）
- [[CET4-阅读-仔细阅读泛读与主旨定位]] — 听力阅读中的主旨把握

### 对比辨析
- 新闻听力 vs 篇章听力：新闻听力语速快、信息密集（通常3-4题），篇章听力语速适中、逻辑清晰——新闻更重抓关键词，篇章更重整体理解
- 视听一致原则 vs 同义替换原则：视听一致是听到什么选什么（基础策略），同义替换是听懂意思找到匹配（进阶策略）
