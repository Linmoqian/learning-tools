...
> [!warning] ⚡️ **考点**: 加逗号 = 非限制性定语；不加逗号 = 限制性定语。
...
> [!warning] ⚡️ **考点**: such as 后面接名词复数形式，三个例子用逗号和 and 连接。
...
| 知识点 | 类型 | 说明 |
|--------|------|------|
| 三段式框架 | 结构模板 | 扩写后的句子嵌入三段式框架 |
| 正反论证 | 论证方法 | 论证内容需要扩写句子 |
| 分类论证 | 论证方法 | 论证内容需要扩写句子 |
| 举例论证 | 论证方法 | 论证内容需要扩写句子 |
