...
> [!warning] **考点**: spend time/money (in) doing something 是固定搭配，花时间/金钱做某事。
...
> [!warning] **考点**: "被人们描述为"中的"被人们"是虚词（没说是具体谁），不需要翻译成 by people——直接用过去分词 described。
...
> [!warning] **考点**: "一年四季"不会写 → 替换为 all year round 或 at any time in a year，不要纠结"四季"一定要翻译出 four seasons。
...
### 后续应用
- [[CET4-写作-句子扩写与句型改写]] — 非谓语动词在写作扩写中的应用
- [[CET4-写作-保底原则与核心策略]] — 写作中的语法准确性

### 对比辨析
- 谓语动词 vs 非谓语动词：谓语动词是句子的核心（有人称/时态/语态变化），非谓语动词不能单独作谓语（V-ing/V-ed/to do）
- 现在分词（主动进行）vs 过去分词（被动完成）：现在分词表示主动/正在进行，过去分词表示被动/已经完成
