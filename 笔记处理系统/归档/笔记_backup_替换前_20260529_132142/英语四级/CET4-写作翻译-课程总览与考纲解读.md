...
### 后续应用
- CET4-写作-保底原则与核心策略 — 写作的具体策略
- [[CET4-写作-句子扩写与句型改写]] — 句型的提升
- [[CET4-语法-非谓语动词与被动语态]] — 语法在写作中的应用

### 对比辨析
- 写作 vs 翻译：写作是自主构建英语段落（从思想到英文），翻译是中文→英文的转换（从中文到英文）——两者互相促进但侧重点不同
- 考纲要求 vs 实际评分：考纲给出能力要求（词数、内容、语法），实际评分更注重"可读性"和"准确度"
